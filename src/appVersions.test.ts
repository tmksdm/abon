...
describe('app versions', () => {
  it('использует дату без .1 и последовательные номера выпусков одного дня', () => {
    ...
    expect(oldestFirst).toEqual([
      '260829', '260829.2', '260829.3', '260829.4', '260829.5', '260829.6', '260829.7', '260829.8', '260829.9', '260829.10', '260830', '260830.2', '260830.3', '260830.4', '260830.5', '260830.6', '260830.7', '260831',
    ])
    expect(CURRENT_APP_VERSION).toBe('260831')
  })
})
